...
BLOCK_LIBRARY = {
    ...
    "product_label": {
        ...
        "fields": [
            ...
            {"name": "title_aisle", "label": "Titre etagere", "type": "text"},
            {"name": "title_shelf", "label": "Titre bac", "type": "text"},
            {"name": "style.label_width", "label": "Largeur etiquette", "type": "text"},
            {"name": "style.label_height", "label": "Hauteur etiquette", "type": "text"},
            {"name": "style.label_padding", "label": "Padding etiquette", "type": "text"},
            {"name": "style.label_gap", "label": "Ecart interne", "type": "text"},
            {"name": "style.grid_gap", "label": "Ecart grille", "type": "text"},
            ...
            {"name": "style.footer_gap", "label": "Ecart bas", "type": "text"},
