    ...
    *,
    ...
    AssociationPortalContact.objects.update_or_create(
        ...
        defaults={
            ...
            "phones": f"+3360000000{code}",
            "emails": _scenario_email(f"admin-{code}", namespace),
            "address_line1": f"{code.upper()} avenue locale",
            "postal_code": "75001",
            "city": "Paris",
            "country": "France",
    ...
    AssociationPortalContact.objects.update_or_create(
        ...
        defaults={
            ...
            "phones": f"+3361000000{code}",
            "emails": _scenario_email(f"shipping-{code}", namespace),
            "address_line1": f"{code.upper()} quai logistique",
            "postal_code": "75002",
            "city": "Paris",
            "country": "France",
