...
class ScanAdminViewTests(TestCase):
    ...
    def test_scan_admin_contacts_renders_admin_management_links(self):
        ...
        self.assertContains(response, "Admin Django canonique")
        ...
        self.assertContains(response, reverse("admin:wms_portalaccessgrant_changelist"))
        self.assertContains(response, reverse("admin:wms_shipmentrecipientorganization_changelist"))
        self.assertContains(response, reverse("admin:wms_recipientproductpreference_changelist"))
        self.assertContains(response, reverse("admin:wms_recipientstructuredocument_changelist"))
