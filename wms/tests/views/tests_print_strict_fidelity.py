...
class PrintStrictFidelityTests(TestCase):
    ...
    def test_render_donation_certificate_preserves_required_wording(self):
        ...
        self.assertNotIn("Valeur uniquement pour la douane : 1.00 euro -", content)
        ...
        self.assertIn("grid-template-columns: 42mm minmax(0, 1fr);", content)
        self.assertIn("width: 42mm;", content)
    ...
    def test_render_shipment_note_preserves_legacy_sheet_sections(self):
        ...
        self.assertIn("messmed@aviation-sans-frontieres-fr.org // +33 6 50 03 72 36", content)
        self.assertIn("grid-template-columns: 1fr;", content)
        self.assertIn("Téléphone /", content)
        self.assertNotIn("TELEPHONE /", content)
        self.assertIn("font-size: 8.7pt;", content)
        self.assertIn("font-size: 9pt;", content)
        self.assertIn("padding: 1.3mm 1.5mm;\n    font-size: 12pt;", content)
        self.assertNotIn("font-size: 6.7pt;", content)
        self.assertNotIn("font-size: 7pt;", content)
    ...
    def test_render_customs_note_preserves_legacy_sheet_sections(self):
        ...
        self.assertIn("font-size: 8.7pt;", content)
        self.assertIn("padding: 1.3mm 1.5mm;\n    font-size: 12pt;", content)
        self.assertIn("padding: 2.4mm;\n    font-size: 9pt;", content)
        self.assertNotIn("font-size: 6.7pt;", content)
        self.assertNotIn("font-size: 7pt;", content)
        self.assertIn("sheet-en", content)
        self.assertIn("sheet-highlight", content)
    ...
    def test_render_shipment_packing_list_preserves_legacy_sheet_sections(self):
        ...
        self.assertIn("@page { size: A4 portrait; margin: 10mm; }", content)
        ...
        self.assertIn('class="packing-destination-value"', content)
        self.assertIn(">1 RUE TEST<", content)
    ...
    def test_render_carton_packing_list_preserves_legacy_sheet_sections(self):
        ...
        self.assertIn("packing-sheet-logo", content)
        self.assertIn("LISTE DE COLISAGE", content)
        self.assertIn("packing-sheet-ref", content)
    ...
    def test_render_shipment_label_preserves_stable_visual_slots(self):
        ...
        self.assertIn("font-size: 48pt;", content)
        self.assertIn("font-size: 66pt;", content)
        self.assertIn("font-size: 38pt;", content)
        self.assertIn("min-height: 3em;", content)
        self.assertIn("--label-iata-block-width: 72mm;", content)
        self.assertIn("width: var(--label-iata-block-width);", content)
        self.assertIn("height: var(--label-iata-block-width);", content)
        self.assertIn("flex: 0 0 38%;", content)
        self.assertIn("max-width: 38%;", content)
        self.assertNotIn("flex: 0 0 33%;", content)
        self.assertNotIn("max-width: 33%;", content)
