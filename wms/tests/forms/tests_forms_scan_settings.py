...
class ScanRuntimeSettingsFormTests(TestCase):
    ...
    def test_form_accepts_minimum_one_values(self):
        form = ScanRuntimeSettingsForm(
            data=self._payload(
                ...
                pilotage_dispute_unassigned_hours=1,
                pilotage_workflow_blockage_unclaimed_hours=1,
                pilotage_queue_backlog_threshold=1,
                pilotage_planning_tension_pct=1,
                pilotage_planning_critical_pct=1,
    ...
    def test_form_without_instance_applies_default_review_values(self):
        form = ScanRuntimeSettingsForm(
            data=self._payload(change_note=""),
        )
