...
- `SCAN_BOOTSTRAP_ENABLED` (optional, default `true`, Bootstrap actif par défaut; pilotable ensuite via `scan/admin/design/`)
...
export SCAN_BOOTSTRAP_ENABLED="true"
```
...
- `false`: rollback immédiat vers l'interface legacy.
