...
## UI Bootstrap
- L’UI web unique est l’UI Django servie par templates.
- Bootstrap 5.3.3 est chargé de façon inconditionnelle sur les surfaces scan, portail, accueil et admin personnalisées.
- Le superuser peut ajuster directement les tokens visuels via `scan/admin/design/`.
