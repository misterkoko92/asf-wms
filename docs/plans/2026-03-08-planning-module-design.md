...
- la source vols API est maintenant branchee via un client concret Air France-KLM, avec expansion des routings multi-escales en destinations candidates, mais il reste a valider la couverture metier sur des jeux reels
