...
- Prioriser **Phase 0** immédiatement (stabilité et sécurité de release).
- Lancer **Phase 1** ensuite, car le domaine contacts est le principal levier de robustesse métier.
- N'engager la V2 fonctionnelle qu'après nettoyage des invariants de base.
