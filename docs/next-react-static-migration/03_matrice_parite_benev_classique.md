...
|---|---|---|---|---|---|
| P1 | `/scan/dashboard/` | `/app/scan/dashboard/` | ecran present, KPI/timeline/actions + filtre destination + bloc stock sous seuil branches en live API | `GET /api/v1/ui/dashboard/` | IN_PROGRESS |
...
- [x] workflow navigateur dashboard live (timeline + actions + filtre destination + stock sous seuil): `wms/tests/core/tests_ui.py::NextUiTests`
